...
const { visible: dialogVisible, form, isEdit, open, submit } = useCrudDialog({
    ...
    defaults: { employee_id: null, date: "", time_in: "", time_out: "", notes: "", status: "pending" },
    fill: (log) => ({
...
<template>
    ...
    <div class="page">
        ...
        <Card>
            ...
            <template #content>
                <DataTable :value="visibleLogs" dataKey="id" v-model:filters="filters" :globalFilterFields="['employee.full_name', 'employee.employee_no', 'notes', 'status']" paginator :rows="10" :rowsPerPageOptions="[10, 25, 50]" removableSort responsiveLayout="scroll">
                    <template #header>
